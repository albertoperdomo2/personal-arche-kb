...
- [[2026-08-05 - Gemma 4 31B IT two-replica KV-cache offload comparison/02 - Prompt-token sources - baseline and CPU|Prompt-token sources — baseline and CPU]]
- [[2026-08-05 - Gemma 4 31B IT two-replica KV-cache offload comparison/03 - Prompt-token sources - NVMe and CephFS|Prompt-token sources — NVMe and CephFS]]
- [[2026-08-05 - Gemma 4 31B IT two-replica KV-cache offload comparison/04 - Per-replica generation throughput|Per-replica generation throughput]]
- [[2026-08-05 - Gemma 4 31B IT two-replica KV-cache offload comparison/05 - Scheduler pressure - baseline and CPU|Scheduler pressure — baseline and CPU]]
- [[2026-08-05 - Gemma 4 31B IT two-replica KV-cache offload comparison/06 - Scheduler pressure - NVMe and CephFS|Scheduler pressure — NVMe and CephFS]]
- [[2026-08-05 - Gemma 4 31B IT two-replica KV-cache offload comparison/07 - HBM KV-cache utilization by replica|HBM KV-cache utilization by replica]]
- [[2026-08-05 - Gemma 4 31B IT two-replica KV-cache offload comparison/08 - External-prefix hit rate by replica|External-prefix hit rate by replica]]
- [[2026-08-05 - Gemma 4 31B IT two-replica KV-cache offload comparison/09 - NVMe performance|NVMe performance]]
- [[2026-08-05 - Gemma 4 31B IT two-replica KV-cache offload comparison/10 - CephFS performance|CephFS performance]]
