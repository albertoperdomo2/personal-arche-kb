...
- The 2026-09-09 Qwen3-32B bimodal run validates that the selective router-to-vLLM path changes external loading, but it is invalid for performance ranking or threshold calibration. Unsaturated cells had at most 3.84% external prompt-token share in the control, streams 512 was overloaded, and the two arms shared the same nodes and host NVMe path. See [[Qwen3-32B/2026-09-09 - Qwen3-32B selective loading bimodal comparison]].
