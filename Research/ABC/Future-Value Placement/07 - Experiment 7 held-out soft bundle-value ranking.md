...
~~~vega-lite
{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","background":"white","title":"Figure 1 — Bundle reuse prevalence changes sharply with pressure","width":620,"height":280,"data":{"values":[{"condition":"C32","class":"Reused later","bundles":203},{"condition":"C32","class":"Not reused later","bundles":688},{"condition":"C64","class":"Reused later","bundles":965},{"condition":"C64","class":"Not reused later","bundles":293}]},"mark":{"type":"bar"},"encoding":{"x":{"field":"condition","type":"nominal","title":"Held-out pressure condition"},"y":{"field":"bundles","type":"quantitative","title":"Source-request bundles (count)","scale":{"zero":true}},"color":{"field":"class","type":"nominal","title":"Future outcome","scale":{"scheme":"category10"}},"xOffset":{"field":"class"},"tooltip":[{"field":"condition","type":"nominal","title":"Condition"},{"field":"class","type":"nominal","title":"Outcome"},{"field":"bundles","type":"quantitative","title":"Bundles"}]}}
~~~
