...
```vega-lite
{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","title":"Figure 2 - Completed requests above TTFT thresholds","data":{"values":[{"case":"N0 over 7s","requests":28},{"case":"N100 over 7s","requests":12},{"case":"N0 over 8s","requests":8},{"case":"N100 over 8s","requests":1},{"case":"N0 over 9s","requests":3},{"case":"N100 over 9s","requests":0}]},"mark":"bar","encoding":{"x":{"field":"case","type":"nominal","title":"TTFT threshold and configuration"},"y":{"field":"requests","type":"quantitative","title":"Completed requests (count)"}}}
```
