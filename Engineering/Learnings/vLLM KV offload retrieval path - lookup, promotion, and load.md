...
| `ref_cnt = -1` means "write in flight" | Distinguishes "allocated but not yet valid" from "resident"; surfaces as `HIT_PENDING` | [`cpu/manager.py:227`](https://github.com/vllm-project/vllm/blob/4ee9702bee668a447e9983a6aefc16ebbc3ad32e/vllm/v1/kv_offload/cpu/manager.py#L227) |
